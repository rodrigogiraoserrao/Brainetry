...
def E(c,de=0,env=None):
 ...
 #i=input(" inp >> ")if {*",;"}&{*l} else"0"*_nio; _nio and (i:=i.split("\n"))
 i=print(" inp >> ",end="",flush=True) and sys.stdin.read()if {*",;"}&{*l} else"0"*_nio; _nio and (i:=i.split("\n")[:-1])
 i,p,m,o=I(l,i,r=0,de=de,_=_); print(); return i,p,m,o
